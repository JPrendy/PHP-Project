<!--Booklist.php- this displays the first 5 books in the database-->
...
<!--this displays the all the books in the table books but it limits to the first 5 rows in books-->
